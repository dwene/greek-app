...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      js: {
        files: ['<%= yeoman.mobile %>/scripts/{,*/}*.js'],
      ...
      styles: {
        files: ['<%= yeoman.mobile %>/styles/{,*/}*.css','<%= yeoman.mobile %>/styles/less/*.less'],
      ...
      livereload: {
        ...
        files: [
          '<%= yeoman.mobile %>/{,*/}*.html',
          '.tmp/styles/{,*/}*.css',
          '<%= yeoman.mobile %>/images/{,*/}*.{png,jpg,jpeg,gif,webp,svg}'
        ]
      }
    },
    ...
    less: {
      development: {
        ...
        files: {
          "<%= yeoman.mobile %>/styles/main.css": "<%= yeoman.mobile %>/styles/less/main.less"
        }
      },
      production: {
        options: {
