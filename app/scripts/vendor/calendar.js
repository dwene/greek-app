...
.controller('CalendarController', ['$scope', '$attrs', '$parse', '$interpolate', '$location', '$log', 'dateFilter', 'calendarConfig', function ($scope, $attrs, $parse, $interpolate, $location, $log, dateFilter, calendarConfig) {
   var self = this,
...
.directive('weekview', ['dateFilter', '$timeout', function (dateFilter, $timeout) {
   return {
      restrict: 'EA',
      replace: true,
      templateUrl: '../views/templates/rcalendar/week.html',
      require: '^calendar',
      link: function (scope, element, attrs, ctrl) {
         $timeout(function () {
            updateScrollGutter();
...
.directive('dayview', ['dateFilter', '$timeout', function (dateFilter, $timeout) {
   return {
      restrict: 'EA',
      replace: true,
      templateUrl: '../views/templates/rcalendar/day.html',
      require: '^calendar',
      link: function (scope, element, attrs, ctrl) {
         $timeout(function () {
            updateScrollGutter();
