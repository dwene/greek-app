    ...
    return {
      ...
      link: function(scope, elem, attrs) {
        ...
        handler = function() {
          ...
          shouldScroll = elementBottom <= $('body').scrollTop() + $(window).height() + 50;
//            console.log('should scroll', elementBottom <= $('body').scrollTop() + $(window).height() + 50);
//            console.log('greater than', $('body').scrollTop() + $(window).height() + 100);
//            console.log('elementBottom', elementBottom);
//            console.log('scroll distance', scrollDistance);
//            console.log('remaining', remaining);
//            console.log('containterBottom', height(container));
          if (shouldScroll) {
